...
*/
export async function sendLocation(chatId, latitude, longitude, location = null){
  var chat = await WAPI.sendExist(chatId);

  if(chat.erro === false || chat.__x_id){
      var ListChat = await Store.Chat.get(chatId);
       var tempMsg = await Object.create(Store.Msg.models.filter(msg => msg.__x_isSentByMe && !msg.quotedMsg)[0]);
     ...
     var extend = {
      ...
      var m = {latitude: latitude, longitude: longitude, title: location, type: "location"}, 
