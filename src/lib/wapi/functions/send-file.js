...
export async function sendFile(imgBase64, chatid, filename, caption, type) {
  ...
  if(typeof filename != "string" && filename != null || typeof caption!= "string" && caption != null){
  ...
  if(chat.erro === false || chat.__x_id){
    ...
    var mediaBlob = base64ToFile(imgBase64, filename),
     ...
     result = await (Promise.all((ListChat)? await media.sendToChat(chat, { caption: caption }) : ""));
     result = result.join('');
